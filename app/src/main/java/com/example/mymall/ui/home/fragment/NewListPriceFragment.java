...
public class NewListPriceFragment extends BaseFragment<INewGood.INewGoodPersenter> implements INewGood.INewGoodView {
    ...
    public NewListPriceFragment(NewListBean bean, String order) {
        this.bean = bean;
        this.order = order;
    }
